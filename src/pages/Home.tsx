...
export default function Home() {
 return <>
  ...
  <section className="container-shell pb-24"><div className="contact-cta relative overflow-hidden"><Radar className="absolute -right-5 -top-6 size-52 text-brand/15"/><p className="eyebrow">Open channel</p><h2 className="relative mt-4 max-w-2xl text-4xl font-semibold tracking-tight sm:text-6xl">Have a project, role, or technical challenge?</h2><p className="relative mt-5 max-w-xl leading-7 text-slate-300">Let’s talk about IT support, networking, security, or a new opportunity.</p><div className="relative mt-8 flex flex-wrap gap-3"><Link to="/contact" className="rounded-full bg-white px-5 py-3 font-semibold text-[#071322]">Send a message <ArrowUpRight className="inline" size={17}/></Link><a href={contact.githubUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full border border-white/20 px-5 py-3 font-semibold text-white"><Github size={17}/> GitHub</a></div></div></section>
 </>;
}
